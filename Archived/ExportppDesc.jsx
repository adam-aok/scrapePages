...
//compares the length of the story to see if it's the longest string represented so far         
         if(myStory.length > largest.length){
             largest = myStory;
             }
    ...
    myStoryText = myStoryText +"\"" + app.activeDocument.name + "\"\,"+ "\"" + largest + "\"\,";
